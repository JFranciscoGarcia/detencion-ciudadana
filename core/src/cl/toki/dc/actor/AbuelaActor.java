...
public class AbuelaActor extends Personaje {
	...
	public void cargarAnimaciones() {
		correAnimacion = new Animation(correAnimacionVel,
				FrameUtil.cortarTextura("abuela.png", 10, 1, false));

		saltoDerAnimacion = new Animation(0.05f, FrameUtil.cortarTextura(
				"abuela.png", 10, 1, false));
		...
		paradoDerAnimacion = new Animation(0.03f, FrameUtil.cortarTextura(
				"abuela.png", 10, 1, false));

	}
	
	public String getDescripcion() {
		return "Sra. meche es una anciana ágil para esquivar cosas pero lenta para tomar velocidad";
	}
